...
(
  ...
  "CONSIGNEE_PHONE"   VARCHAR2(200),
  "CONSIGNEE_ADDRESS" VARCHAR2(300),
  "CITY" VARCHAR2(300),
  "HOUSE_NUMBER" VARCHAR2(300),
  "DEFAULT_ADDRESS"   VARCHAR2(300),
  "IS_DEFAULT"        NUMBER(3, 0),
...
SELECT PRODUCT_NAME FROM PRODUCT WHERE PRODUCT_NAME='银耳';
...
ALTER TABLE HAH DROP COLUMN USER_ID;
ALTER TABLE HAH ADD (SEARCH_TIME VARCHAR2(100),SEARCH_NUMBER VARCHAR2(100),SEARCH_CONTENT CLOB,SEARCH_TYPE LONG);
...
ALTER TABLE S_LOG ADD(REQUEST_METHOD VARCHAR2(100),CLASS_METHOD VARCHAR2(100),REQUEST_ARGS CLOB,HANDLER_TIME LONG);
ALTER TABLE S_LOG DROP COLUMN SYSTEM_ID;


CREATE TABLE "QJJ"."SHOPPING_CART"
(
  "ID"      VARCHAR2(32) NOT NULL ENABLE,
  "USER_ID" VARCHAR2(32),
  "ORDER_ID_LIST"  CLOB,
...
CREATE TABLE "QJJ"."PRO_AND_SHOP"
(
  "ID"             VARCHAR2(32) NOT NULL,
  "PRODUCT_ID"        VARCHAR2(32),
  "SHOPPING_CART_ID" VARCHAR2(32),
  "PRODUCT_NUMBER"         NUMBER(6, 0),
  PRIMARY KEY ("ID")
);

CREATE TABLE "QJJ"."SEARCH_QUERY"
(	"ID" VARCHAR2(32) NOT NULL ENABLE,
   "SEARCH_TYPE" NUMBER(6,0),
   "SEARCH_CONTENT" VARCHAR2(1000),
   "USER_ID" VARCHAR2(32),
   "SEARCH_TIME" TIMESTAMP (6),
   "SEARCH_NUMBER" NUMBER(6,0),
  PRIMARY KEY ("ID")
);



CREATE TABLE "QJJ"."ORDER_ITEM"
(	"ID" VARCHAR2(32) NOT NULL ENABLE,
